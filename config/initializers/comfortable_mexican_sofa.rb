...
ComfortableMexicanSofa.configure do |config|
  ...
  config.cms_title = 'CEDPHX Content Management System'
  ...
  #   bucket: Proc.new{APP_CONFIG[:cms_upload_bucket]},
  #   path: "#{Rails.env}/cms/:class/:id/:attachment/:style/:filename"
  # }
...
ComfortableMexicanSofa::HttpAuth.username = 'stevetong83'
ComfortableMexicanSofa::HttpAuth.password = 'admin1'
